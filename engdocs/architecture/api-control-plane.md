...
slow clients. For the integration-only
`ServeSeededCity` handler, cancel its parent context or call the returned stop
function before shutting down the externally owned `http.Server`.
